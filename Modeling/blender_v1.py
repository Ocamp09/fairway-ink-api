...
def main():
    ...
    # for use in blender
    in_file = "recent.svg"
    dir_path = pathlib.Path.home() / "Documents" / "Coding" / "golf-marker" / "Modeling"
...
#    dir_path = pathlib.Path.cwd()
    ...
    stl_path = dir_path / "template.stl"
    print(image_path)
    ...
    if image_path.exists(): 
        ...
        bpy.ops.transform.resize(value=(-60, -60, -60), orient_type='GLOBAL', orient_matrix=((1, 0, 0), (0, 1, 0), (0, 0, 1)), orient_matrix_type='GLOBAL', mirror=False, use_proportional_edit=False, proportional_edit_falloff='SMOOTH', proportional_size=1, use_proportional_connected=False, use_proportional_projected=False, snap=False, snap_elements={'INCREMENT'}, use_snap_project=False, snap_target='CLOSEST', use_snap_self=True, use_snap_edit=True, use_snap_nonedit=True, use_snap_selectable=False)
